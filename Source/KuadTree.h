#ifndef __KuadTree_h__
#define __KuadTree_h__
...
template<typename TYPE>
inline void KuadTree::CollectIntersections(std::vector<GameObject*>& gameObject, const TYPE& primitive) const {
	if (root != nullptr) {
