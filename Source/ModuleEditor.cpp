...
{
	BROFILER_CATEGORY("EditorPreUpdate()", Profiler::Color::Aqua);
...
{
	BROFILER_CATEGORY("EditorUpdate()", Profiler::Color::Aqua);
	if (ImGui::BeginMainMenuBar()) 
	{
		...
		if (ImGui::BeginMenu("Help")) 
		{
			...
			{
				App->OpenWebBrowser("https://github.com/Gabroide/ValarMorghulis");
			}

			if (ImGui::MenuItem("Author's GitHub Repo"))
			{
				App->OpenWebBrowser("https://github.com/Gabroide/");
			}

			if (ImGui::MenuItem("Last Release"))
			{
				App->OpenWebBrowser("https://github.com/Gabroide/ValarMorghulis/Release");
			}
